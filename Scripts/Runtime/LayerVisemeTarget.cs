...
public class LayerVisemeTarget : MonoBehaviour
{
    ...
    private static readonly int Viseme = Animator.StringToHash("Viseme");
    private static readonly int VisemeBlend = Animator.StringToHash("VisemeBlend");
    ...
    void SetVisemeToAnimState()
    {
        ...
        if (gV != -1)
        {
            _animator.SetInteger(Viseme, gV);
            _animator.SetFloat(VisemeBlend, gV);
        }
    }
}
